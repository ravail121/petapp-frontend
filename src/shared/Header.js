    ...
    <header className="header-area style-3">
      <div className="container d-flex justify-content-between align-items-center">
        <div className="header-logo">
            <a href="index.html"><img alt="image" className="img-fluid" src={logo} /></a>
        </div>
        <div className="main-menu">
          <div className="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
            <div className="mobile-logo-wrap">
              <a href="index.html"><img alt="image" src={logo} /></a>
            </div>
          ...
          <ul className="menu-list">
              <li><a href="" onClick={() => props.navigate('/home')}>Home</a></li>
              <li><a href="" onClick={() => props.navigate('/about')}>About</a></li>
              <li className="menu-item-has-children">
                <a href="#">Products</a><i className="bi bi-plus dropdown-icon"></i>
              ...
              <li className="menu-item-has-children">
                <a href="#">Shop</a><i className="bi bi-plus dropdown-icon"></i>
                <ul className="sub-menu">
                  <li><a href="" onClick={() => props.navigate('/shop')}>Shop Now</a></li>
        ...
        <div className="nav-right d-flex jsutify-content-end align-items-center">
          <ul>
            ...
            <li><a href="" onClick={() => props.navigate('/login')}>
              <svg width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
